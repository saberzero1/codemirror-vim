...
export const KNOWN_DEVIATIONS: Deviation[] = [
    ...
    },
    {
        ...
        description: 'Per-step: % matches comment bracket at different position than Neovim',
        reason: 'fixable',
        fields: ['cursor'],
    },
    {
        testPattern: /^vim_S_normal$/,
        description: 'Per-step: S autoindent adds spaces where Neovim leaves empty line',
        reason: 'fixable',
        fields: ['content', 'cursor'],
    },
    {
        testPattern: /^vim_jumpToMark_next_action$/,
        description: 'Per-step: d]` deletes different range than Neovim (mark jump scope)',
        reason: 'fixable',
        fields: ['content'],
    },
    {
    ...
    {
        testPattern: /^vim_ex_(advanced_range_syntax|substitute_visual_range|noh_clearSearchHighlight)$/,
        description: 'Per-step: ex command cursor positioning differs from Neovim',
        reason: 'fixable',
        fields: ['cursor'],
    },
    {
